...
public class lianxi extends AppCompatActivity {
    ...
    public void getAppIDAndUserIDAndAppSign(){
        appID = 609408564L;
        userID = "000333";
        appSign = "59fb6b3d70836007ba898832b22da9917c76576b26436737a218dbd538eb33d7";
    }
    ...
    public void setStartScreenCaptureButtonEvent(){
        startScreenCaptureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isPublish){
                    //现在是正在推流中,点击,然后就停止推流
                    startScreenCaptureButton.setText("开始屏幕采集(改的)");
                    ...
                    startScreenCaptureButton.setText("停止屏幕采集(改的)");
                    isPublish = true;
                }
            }
        });
...
//        Log.d("检测", "setVideoConfig: " + bitrateEdit.getText().toString());
    ...
    public static void actionStart(Activity activity) {
        Intent intent = new Intent(activity, lianxi.class);
